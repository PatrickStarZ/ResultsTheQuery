...
public class OkhttpUtil {
     ...
     * @return
     */
    public  void getDataAsynFromNet(String url, String cookie,final MyNetCall myNetCall) {
        //1 构造Request
        Request request =  new Request.Builder().addHeader("Cookie", cookie).get().url(url).build();
